...
import (
 ...
 "github.com/verygoodsoftwarenotvirus/zhuzh/backend/internal/observability/tracing"
 "github.com/verygoodsoftwarenotvirus/zhuzh/backend/pkg/apiclient"
 "github.com/verygoodsoftwarenotvirus/zhuzh/backend/pkg/types"

 "github.com/pquerna/otp/totp"
)

func main() {
 u, err := url.Parse("https://api.zhuzh.dev")
 if err != nil {
  panic(err)
 }
...
import (
 ...
 databasecfg "github.com/verygoodsoftwarenotvirus/zhuzh/backend/internal/database/routingcfg"
 "github.com/verygoodsoftwarenotvirus/zhuzh/backend/internal/database/postgres"
 "github.com/verygoodsoftwarenotvirus/zhuzh/backend/internal/observability/logging"
 "github.com/verygoodsoftwarenotvirus/zhuzh/backend/internal/observability/tracing"
)
