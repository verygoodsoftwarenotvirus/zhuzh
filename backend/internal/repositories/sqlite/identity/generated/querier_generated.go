...
type Querier interface {
	...
	CheckAccountInvitationExistence(ctx context.Context, db DBTX, id string) (string, error)
	...
	GetEmailVerificationTokenByUserID(ctx context.Context, db DBTX, id string) (*string, error)
	...
	GetUserByEmailAddressVerificationToken(ctx context.Context, db DBTX, emailAddressVerificationToken *string) (*GetUserByEmailAddressVerificationTokenRow, error)
	...
	UserIsAccountMember(ctx context.Context, db DBTX, arg *UserIsAccountMemberParams) (string, error)
}
