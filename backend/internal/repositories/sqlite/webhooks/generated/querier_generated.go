...
type Querier interface {
	...
	CheckWebhookExistence(ctx context.Context, db DBTX, arg *CheckWebhookExistenceParams) (string, error)
	CheckWebhookTriggerEventExistence(ctx context.Context, db DBTX, id string) (string, error)
