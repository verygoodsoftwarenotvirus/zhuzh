...
type Querier interface {
	...
	CheckUserDeviceTokenExistence(ctx context.Context, db DBTX, arg *CheckUserDeviceTokenExistenceParams) (string, error)
	CheckUserNotificationExistence(ctx context.Context, db DBTX, arg *CheckUserNotificationExistenceParams) (string, error)
