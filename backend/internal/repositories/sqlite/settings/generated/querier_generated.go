...
type Querier interface {
	...
	CheckServiceSettingConfigurationExistence(ctx context.Context, db DBTX, id string) (string, error)
	CheckServiceSettingExistence(ctx context.Context, db DBTX, id string) (string, error)
