...
RUN --mount=type=cache,target=/root/.cache/go-build go build -trimpath -o /coordination-server github.com/verygoodsoftwarenotvirus/zhuzh/backend/cmd/tools/test_coordination_server
